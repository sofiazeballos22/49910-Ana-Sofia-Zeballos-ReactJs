...
import QuantitySelector from "./QuantlySelector";
...

          {
            isInCart( item.id )
              ...
              : <>
                  ...
                  />          
                  <Boton className="text-white px-10 text-xl bg-rose-800"
                  onClick={handleAgregar} disabled={item.stock === 0}>Agregar al carrito</Boton>
                </>
          }
        </div>
      </div>
